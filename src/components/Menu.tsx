...
const Menu = ({ isMenuOpen, setIsMenuOpen, }: MenuProps) => {
    return (
        <div className={`absolute flex justify-center items-center z-10 w-full md:w-[500px] transition-all duration-300 ease-in-out ${isMenuOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
            ...
            <div className='flex flex-col gap-2 z-2 px-16 md:px-24 items-center w-full'>
                <h1 className="text-4xl md:text-5xl text-center mb-3 text-black font-bold">Vítej bludimíre</h1>
                ...
                <p className='text-black text-[18px] text-center'>Chtěl by jsi vědět kdy a kde? Smolík pacholík!</p>
